...
public class VentanaIniciarSesion extends javax.swing.JFrame
{
    ...
    {
        initComponents();
        this.botonInicia.setActionCommand(VentanaIniciarSesion.INICIO);
        this.setVisible(true);
    }
    
    public void mensajeDeError(String s)
    {
        JOptionPane.showMessageDialog(this, s);
    }
    public void addActionListener(ActionListener al)
    {
        this.botonInicia.addActionListener(al);
    }
    public String darTextoUsuario(){
        return this.textFieldUsuario.getText();
    }
    public String darTextoContra()
    {
        char[] arrayC = this.fieldContrasena.getPassword(); 
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        botonInicia.setText("INICIAR SESION");
        jPanel6.add(botonInicia);
